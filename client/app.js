...
angular.module('myApp', [
  ...
  .config(function Config($httpProvider, jwtInterceptorProvider, jwtOptionsProvider, $locationProvider) {
    console.log("config", $httpProvider, jwtInterceptorProvider, jwtOptionsProvider, $locationProvider);
